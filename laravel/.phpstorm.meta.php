...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/alexverbraecken/Documents/GitHub/Hoops-CMS/laravel/public/storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/alexverbraecken/Documents/GitHub/Hoops-CMS/laravel/public/storage','inertia.ssr.enabled','inertia.ssr.runtime',
...
'session.http_only','session.same_site','session.partitioned','session.serialization','debugbar.enabled',
...
'debugbar.openhandler','debugbar.cache.delete','debugbar.queries.explain','debugbar.clockwork','debugbar.assets','admin.login','admin.post.login','admin.password.request',
'admin.password.email','admin.password.reset','admin.password.update','admin.dashboard','admin.logout',
'admin.preferences.theme','admin.preferences.timezone','admin.pages.index','admin.pages.create','admin.pages.store',
'admin.pages.edit','admin.pages.update','admin.pages.destroy','admin.pages.restore','admin.pages.forceDelete',
'admin.pages.autosave','admin.pages.duplicate','admin.posts.index','admin.posts.create','admin.posts.store',
'admin.posts.edit','admin.posts.update','admin.posts.destroy','admin.posts.restore','admin.posts.forceDelete',
'admin.posts.autosave','admin.posts.duplicate','admin.categories.index','admin.categories.create','admin.categories.store',
'admin.categories.edit','admin.categories.update','admin.categories.destroy','admin.categories.restore','admin.categories.forceDelete',
'admin.tags.index','admin.tags.store','admin.tags.update','admin.tags.destroy','storage.local',
...
'SESSION_SECURE_COOKIE','SESSION_HTTP_ONLY','SESSION_SAME_SITE','BROADCAST_CONNECTION','FILESYSTEM_DISK',
'QUEUE_CONNECTION','CACHE_STORE','MEMCACHED_HOST','REDIS_HOST','MAIL_MAILER',
